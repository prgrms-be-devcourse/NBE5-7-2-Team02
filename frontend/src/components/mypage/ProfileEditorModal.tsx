// components/mypage/ProfileEditorModal.tsx
...
interface Props {
  ...
  username: string;
  profileImage: string;
  onSave: (nickname: string, image: string) => void;
}

export default function ProfileEditorModal({ show, onClose, username, profileImage, onSave }: Props) {
  return (
