...
public class PostBrowserSuccessTest extends BrowserTestTemplate {
    ...
    void getPostsWithRecruitStatus() throws Exception {
        // given
        PostCreateRequest request = new PostCreateRequest("TITLE", "CONTENT", List.of("TAG"), RECRUITING);
        createPostHelper(request);
        ...
        mockMvc.perform(
            ...
            .andExpect(jsonPath("$.data.posts[0].recruitment_status").value(RECRUITING.toString()));
    }
    ...
    void getPostsWithTag() throws Exception {
        ...
        PostCreateRequest request = new PostCreateRequest("TITLE", "CONTENT", List.of(targetTag), RECRUITING);
        createPostHelper(request);
    ...
    void getPostsWithTags() throws Exception {
        ...
        PostCreateRequest targetRequest = new PostCreateRequest("TARGET_TITLE", "TARGET_CONTENT", List.of(targetTags), RECRUITING);
        PostCreateRequest fakeRequest = new PostCreateRequest("FAKE_TITLE", "FAKE_CONTENT", List.of(targetTags[0]), RECRUITING);
