...
public class OAuthService {
        ...
        try {
            ...
            if (body != null && body.containsKey("access_token")) {
                ...
                return GitHubLoginResponse.builder()
                    .accessToken(body.getAsString("access_token")).build();
            }
    ...
    private String fetchPrimaryEmail(HttpEntity<String> entity) {
        ResponseEntity<Object[]> response = restTemplate.exchange(
            "https://api.github.com/user/emails", HttpMethod.GET, entity, Object[].class);
    ...
    public TokenPair login(String accessToken) {
    ...
    private void validatePrgrmsOrganization(List<String> organizations) {
        boolean hasPrgrms = organizations.stream()
            .anyMatch(org -> org.toLowerCase().contains("prgrms"));
